...
Please explore the
challenge_2/challange.md

Understand the goals and constraints then execute this plan

Read this before you start to get an understanding how to create uv single file scripts https://docs.astral.sh/uv/guides/scripts/
...
- **Platform**: I use a Mac system, it only needs to work on macOS

## What

single file uv scripts that:

- Scans all local git branches for age and merge status
- Displays color-coded summary with visual indicators using colorama
...
- [ ] Executes in any git repository without setup or installation (drop in script)
