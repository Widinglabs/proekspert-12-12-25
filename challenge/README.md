# Product Catalog API - Workshop Exercise
...
See **challange/TASK.md** for complete instructions.

## Key Features

### AI-Friendly Code

This codebase demonstrates good practices for AI-assisted development:
